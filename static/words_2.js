...
$(document).ready(function(){
  $("#sound").html(`
      <audio id="originalAudio" ontimeupdate="update(this)">
          <source src="../static/assert/morse_code_sounds/mcs-peace.wav" type="audio/ogg">
          <source src="../static/assert/morse_code_sounds/mcs-peace.wav" type="audio/mpeg">
  ...
  $("#wordProviousBtn2").click(function() {
		window.location.href='/words/1'
  })
  $("#wordNextBtn2").click(function() {
